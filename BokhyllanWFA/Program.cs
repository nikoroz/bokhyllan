        ...
        sealed public class Bibliotekarie
        {
            ...
            public static string HämtaBokLista()
            {
                ...
                if (bokLista.Count != 0)//Om boklistan inte är tom
                {
                    ...
                    {
                        resultatlista += HämtaBokInfo(nuvarandeIndex);
                        nuvarandeIndex++;
                    }
                    resultatlista += "\n\n";
                }else
            ...
            public static string ExporteraBokLista()
            {
                ...
                if (bokLista.Count == 1)
                {
                    attExportera += bokLista[0].Titel + "###" +
                                bokLista[0].Skribent + "###" +
                                bokLista[0].Typ + "###" +
                                bokLista[0].Tillänglig.ToString().ToLower();
                }
                else if (bokLista.Count > 1)
                {
                    for (int i = 0; i < bokLista.Count - 1; i++)
                    {
            ...
            public static string HämtaBokInfo(int bokIndex)
            {
                return "\n\n\tTitel:\t\t" + bokLista[bokIndex].Titel +
                       "\n\tSkribent:\t\t" + bokLista[bokIndex].Skribent +
                       "\n\tUtgivningsår:\t" + bokLista[bokIndex].Utgivningsår +
                       "\n\tTyp:\t\t" + bokLista[bokIndex].Typ +
                       "\n\t" + bokLista[bokIndex].ToString();
            }
        }
